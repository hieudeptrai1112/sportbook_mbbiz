...
export const TAB_DEMO_SECTIONS: TabDemoSection[] = [
  {
    ...
    tags: ['selector=sportbook6vn-tab', 'variant=pill', 'size=large'],
    variant: 'default',
  },
  {
    id: 'type',
    ...
    tags: ['selector=sportbook6vn-tab', 'variant=pill/underlined'],
    variant: 'type',
  },
  {
    id: 'size',
    ...
    tags: ['selector=sportbook6vn-tab', 'size=small'],
    variant: 'size',
  },
  {
    id: 'disabled-count',
    ...
    tags: ['selector=sportbook6vn-tab', 'disabled=true', 'count=12'],
