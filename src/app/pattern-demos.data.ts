...
export const FOOTER_PATTERN_VARIANTS: readonly FooterPatternVariant[] = [
  {
    ...
    actions: [{ label: 'Quay lại', variant: 'secondary', width: 'compact' }],
  },
  {
    id: 'type2',
    title: 'Footer / Type 2',
    ...
    actions: [
      { label: 'Quay lại', variant: 'secondary', width: 'compact' },
      { label: 'Tiếp tục', variant: 'primary', width: 'wide' },
    ],
  },
  {
    id: 'type3',
    ...
    actions: [
      { label: 'Quay lại', variant: 'secondary', width: 'compact' },
      { label: 'Từ chối', variant: 'secondary', width: 'compact' },
      { label: 'Phê duyệt', variant: 'primary', width: 'wide' },
    ],
  },
  {
    id: 'type4',
