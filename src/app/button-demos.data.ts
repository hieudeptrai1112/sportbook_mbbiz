    ...
    rows: [
      {
        ...
        semanticAlias: 'background/brand-primary1',
        appliesTo: 'State=Default',
        notes: 'Default outlined border currently maps to background brand alias.',
      },
      {
      ...
      },
      {
        ...
        semanticAlias: 'background/brand-primary2',
        appliesTo: 'State=Hover',
        notes: 'Hover outlined border currently maps to background brand alias.',
      },
      {
      ...
      },
      {
        ...
        semanticAlias: 'background/brand-primary3',
        appliesTo: 'State=Pressed',
        notes: 'Pressed outlined border currently maps to background brand alias.',
      },
      {
      ...
      },
      {
        ...
        semanticAlias: 'background/brand-primary4',
        appliesTo: 'State=Disabled',
        notes: 'Disabled outlined border currently maps to background brand alias.',
      },
      {
        componentToken: 'ds/button/color/text/pill/secondary/disabled',
        semanticAlias: 'text/brand-primary4',
        appliesTo: 'State=Disabled',
        notes: 'Disabled text role.',
      },
    ],
