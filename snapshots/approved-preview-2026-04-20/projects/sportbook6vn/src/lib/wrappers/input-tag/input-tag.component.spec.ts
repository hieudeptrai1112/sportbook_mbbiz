...
import { Sportbook6vnInputTagComponent, Sportbook6vnInputTagValue } from './input-tag.component';

describe('Sportbook6vnInputTagComponent', () => {
  let fixture: ComponentFixture<Sportbook6vnInputTagComponent>;
  let component: Sportbook6vnInputTagComponent;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(Sportbook6vnInputTagComponent);
  ...
  it('should render tags when provided', () => {
    ...
    const chip = fixture.nativeElement.querySelector('.sportbook6vn-input-tag__chip');
  ...
  it('should render trailing clear action when enabled', () => {
    ...
    const clearButton = fixture.nativeElement.querySelector('.sportbook6vn-input-tag__clear');
    expect(clearButton).not.toBeNull();
  });

  it('should create a tag when pressing Enter', async () => {
    const input = fixture.nativeElement.querySelector('input') as HTMLInputElement;
    const emittedValues: Sportbook6vnInputTagValue[][] = [];
  ...
  it('should remove the last tag when Backspace is pressed on an empty input', () => {
    ...
    const chips = fixture.nativeElement.querySelectorAll('.sportbook6vn-input-tag__chip');
  ...
  it('should collapse overflow tags when maxTagCount is set', () => {
    ...
    const chips = fixture.nativeElement.querySelectorAll(
      '.sportbook6vn-input-tag__content > .sportbook6vn-input-tag__chip',
    );
    const overflow = fixture.nativeElement.querySelector(
      '.sportbook6vn-input-tag__content > .sportbook6vn-input-tag__overflow-anchor .sportbook6vn-input-tag__overflow',
    );
  ...
  it('should apply renderTag output to the visible chip', () => {
    ...
    const chip = fixture.nativeElement.querySelector('.sportbook6vn-input-tag__chip');
    expect(chip?.textContent).toContain('USD');
    expect(chip?.classList.contains('sportbook6vn-input-tag__chip--brand')).toBe(true);
  });
  ...
  it('should collapse tags responsively based on available width', () => {
    ...
    const content = fixture.nativeElement.querySelector('.sportbook6vn-input-tag__content') as HTMLElement;
    const chips = fixture.nativeElement.querySelectorAll('.sportbook6vn-input-tag__measure-row .sportbook6vn-input-tag__chip');
    const overflow = fixture.nativeElement.querySelector('.sportbook6vn-input-tag__measure .sportbook6vn-input-tag__overflow') as HTMLElement;
  ...
  it('should render hidden tags inside the overflow popover', () => {
    ...
    const popoverChips = fixture.nativeElement.querySelectorAll(
      '.sportbook6vn-input-tag__overflow-popover .sportbook6vn-input-tag__chip',
    );
