...
import { MbbizItemFileComponent } from './item-file.component';

describe('MbbizItemFileComponent', () => {
  let fixture: ComponentFixture<MbbizItemFileComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MbbizItemFileComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(MbbizItemFileComponent);
    fixture.detectChanges();
  });

  it('renders a default xlsx file from Illustration assets', () => {
    const nativeElement = fixture.nativeElement as HTMLElement;
    const icon = nativeElement.querySelector('.mbbiz-item-file__icon') as HTMLImageElement;
  ...
  it('renders loading progress', () => {
    ...
    const progress = fixture.nativeElement.querySelector('.mbbiz-item-file__progress-bar') as HTMLElement;
  ...
  it('emits remove and download actions', () => {
    ...
    const removeButton = fixture.nativeElement.querySelector('.mbbiz-item-file__action--remove') as HTMLButtonElement;
    const downloadButton = fixture.nativeElement.querySelector('.mbbiz-item-file__action--download') as HTMLButtonElement;
    removeButton.click();
