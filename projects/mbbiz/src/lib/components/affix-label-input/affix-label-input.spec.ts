...
import { MbbizAffixLabelInputComponent } from './affix-label-input.component';

describe('MbbizAffixLabelInputComponent', () => {
  let fixture: ComponentFixture<MbbizAffixLabelInputComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(MbbizAffixLabelInputComponent);
  ...
  it('should render configured affix labels', () => {
    ...
    const affixes = fixture.nativeElement.querySelectorAll('.mbbiz-affix-label-input__affix');
  ...
  it('should render dropdown affix trigger when dropdown items are provided', () => {
    ...
    const trigger = fixture.nativeElement.querySelector('.mbbiz-affix-label-input__affix--dropdown');
  ...
  it('should render dropdown panel when prefix affix is open', () => {
    ...
    const panel = fixture.nativeElement.querySelector('.mbbiz-affix-label-input__panel');
  ...
  it('should render selected affix image when dropdown item has imageUrl', () => {
    ...
    const image = fixture.nativeElement.querySelector('.mbbiz-affix-label-input__affix-image');
