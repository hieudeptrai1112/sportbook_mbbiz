...
const FILE_KINDS: readonly MbbizItemFileKind[] = ['xlsx', 'docx', 'pdf', 'jpg', 'xml'];
const STATUS_TONES: readonly MbbizTableStatusTone[] = [
  'success',
  'error',
  'warning',
  'neutral',
...
export const TABLE_PREVIEW_PRIMITIVE_COLUMNS: readonly MbbizTableColumn[] = Array.from(
  { length: 5 },
  (_, index) => ({
    key: `column${index + 1}`,
    title: 'Title',
...
export const TABLE_PREVIEW_PRIMITIVE_ROWS: readonly MbbizTableRow[] = Array.from(
  { length: 4 },
  (_, rowIndex) => ({
...
export const TABLE_PREVIEW_DEFAULT_COLUMNS: readonly MbbizTableColumn[] = [
...
export const TABLE_PREVIEW_DEFAULT_ROWS: readonly MbbizTableRow[] = [
  {
    id: 'account-1',
...
export const TABLE_PREVIEW_SELECTION_COLUMNS: readonly MbbizTableColumn[] = [
  { key: 'selected', title: 'Title', type: 'checkbox', width: 132 },
  ...TABLE_PREVIEW_DEFAULT_COLUMNS,
];

export const createTablePreviewSelectionRows = (): MbbizTableRow[] =>
...
export const TABLE_PREVIEW_ALL_COLUMNS: readonly MbbizTableColumn[] = [
...
export const createTablePreviewAllColumnRow = (index: number): MbbizTableRow => {
...
export const createTablePreviewAllColumnRows = (): MbbizTableRow[] =>
  Array.from({ length: 5 }, (_, index) => createTablePreviewAllColumnRow(index));

export const TABLE_PREVIEW_FIXED_RIGHT_COLUMNS: readonly MbbizTableColumn[] = [
  { key: 'checkbox', title: 'Title', type: 'checkbox', width: 100 },
...
export const createTablePreviewFixedRightRows = (): MbbizTableRow[] =>
